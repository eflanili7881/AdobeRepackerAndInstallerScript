  ...
  - To patch dylibs:
    ...
    # - On AdobePIM.dylib (version 9.0.0.72)
      - You need to use this version for ZIP-based installers (CC 2013 (7.x.x.x) and above) as CS6 (6.x.x.x) and below will use DMG-based installers.
        ...
        - Now, you got the necessary address for changing **lea eax, [ebp - 0x220]** to **jne 0x14889**. Open AdobePIM.dylib on Cutter with experimental (aaaa) mode and in write mode (-w).
